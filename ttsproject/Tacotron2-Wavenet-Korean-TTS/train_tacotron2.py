    ...
    with tf.Session(config=sess_config) as sess:
        try:
            ...
            while not coord.should_stop():
                ...
                if step == 50:
                    log("Stop at 300000's step (last loss= %.05f)" % loss_window.average)
...
def main():
    ...
    parser.add_argument('--data_paths', default='.\\data\\001M' )
    ...
    #parser.add_argument('--load_path', default='logdir-tacotron2/kaggle_2020-04-25_16-49-33')
    ...
    parser.add_argument('--summary_interval', type=int, default=2000)
    
    parser.add_argument('--test_interval', type=int, default=5000)  # 500
